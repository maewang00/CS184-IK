...
public class IKscene2 : MonoBehaviour
{
    ...
    {
        return -TargetHolder.eulerAngles.y;
    }
    ...
    void ResolveIK2()
    {
        ...
        if (length0 + length1 < length2)
        {
            jointAngle0 = atan - 90;
            jointAngle1 = 0f;
            Debug.Log("CASE 5: stretch out arm!");
            Debug.Log("jointAngle0 = " + jointAngle0);
            Debug.Log("jointAngle1 = " + jointAngle1);
        }
        else
        {
            ...
            Debug.Log("CASE 6: not stretched out!");
            Debug.Log("angle0 = " + angle0);
            Debug.Log("angle0 = " + angle0);
            Debug.Log("jointAngle0 = " + jointAngle0);
            Debug.Log("jointAngle1 = " + jointAngle1);
        }
...
//if (yRot< 0) { jointAngle1 = 0;} // forces no bend past +/- 90 degrees
